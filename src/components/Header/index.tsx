...
function Header() {
  ...
  function ItemNav(props: ItemNavProps) {
    ...
    return (
      <li>
        <a
          href={href}
          className="block py-2 pl-3 pr-4 text-[1.125rem] rounded lg:p-0"
  ...
  return (
    <header className={clsx(styles['header'], menuCollapsed ? styles['active'] : '', scrolled ? 'shadow-md' : '')}>
      <Container overrideClassName className={clsx('xl:px-[150px] lg:px-[100px] lg:pb-4 py-4 [@media(min-width:1440px)]:max-w-[1440px] mx-auto')}>
        <nav className={clsx('lg:p-3.5')}>
          <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
            ...
            <div className="flex items-center lg:order-2 lg:hidden lg:px-0 px-8 gap-3">
